...
#=============================
#Configurations:
$DCMTKFolder = "C:\DICOMTool\bin\"
$Verbose = $FALSE

$DICOMFolder = "E:\Registry\"
...
$DCMDUPM_Param3 = '+P'
$DCMDUPM_Param4 = 'TransferSyntaxUID'
...
$SourceDCMFolders = Get-ChildItem -Recurse -Directory | Select-Object -ExpandProperty Fullname
...
foreach ($TargetFolder in $SourceDCMFolders){
    ...
    Write-Host -NoNewline "Finished processing:"
