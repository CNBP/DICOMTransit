...
from DICOMTransit.Integration.Intermediate_LORIS_LocalDB import (
    findTimePointUpdateDatabase,
)
import unittest
...
class UT_IntegrationTest(unittest.TestCase):
    ...
    def test_updateLocalTimepoint():
        ...
        LocalDB_query.create_entry(
            database_path, table_name, CNBP_blueprint.keyfield, "8987888"
        )
        ...
        # Now, the big guy.
        success, reason = findTimePointUpdateDatabase(
            token, DCCID, database_path, table_name
        )
