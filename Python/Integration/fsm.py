...
class DICOMTransitImport(object):
    ...
    def CheckLocalDBStudyUID(self):
        ...
        list_knownStudyUID = LocalDB.API.get_list_StudyUID()
    ...
    def DeleteSubject(self):
        ...
        if len(self.orthanc_list_all_StudiesUIDs) > self.orthanc_studies_buffer_limit:
            ...
            orthanc.API.delete_study(studyUID)
            logger.info(
    ...
    def CheckLocalUID(self):
        ...
        list_local_series_UID = LocalDB.API.get_SeriesUIDs(self.DICOM_package.MRN)
