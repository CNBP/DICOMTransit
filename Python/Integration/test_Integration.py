...
class UT_IntegrationTest(unittest.TestCase):
    ...
    def test_updateLocalTimepoint():
        ...
        LocalDB_query.create_entry(database_path, table_name, CNBP_blueprint.keyfield, "VSX999999")

        # Update above entry with the right mock PSCID.
        LocalDB_query.update_entry(database_path, table_name, CNBP_blueprint.keyfield, "VSX999999", "DCCID", DCCID, )
