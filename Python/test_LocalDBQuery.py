...
def test_LocalDBQuery():
    ...
    c.execute("INSERT INTO {tn} ({mrn},{cnbpid}) VALUES (295010,'CNBP0010001')".format(tn=tableName, mrn=MRNColumn, cnbpid=CNBPIDColumn))
    c.execute("INSERT INTO {tn} ({mrn},{cnbpid}) VALUES (297120,'CNBP0030001')".format(tn=tableName, mrn=MRNColumn, cnbpid=CNBPIDColumn))
    c.execute("INSERT INTO {tn} ({mrn},{cnbpid}) VALUES (291310,'CNBP0510001')".format(tn=tableName, mrn=MRNColumn, cnbpid=CNBPIDColumn))
    conn.commit()
    conn.close()
